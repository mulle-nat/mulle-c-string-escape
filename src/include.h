 ...
 */
#ifndef mulle_c_string_escape_include_h__
#define mulle_c_string_escape_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "mulle-c-string-escape-include.h" to keep the #include statements in the
...
#include "_mulle-c-string-escape-include.h"
